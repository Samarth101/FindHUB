...
export default function Button({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`
        inline-flex items-center justify-center font-bold border-2 transition-all duration-100
        btn-press shadow-[2px_2px_0px_#2d2d2d] hover:shadow-[3px_3px_0px_#2d2d2d]
