...
const defaultCenter = {
  lat: 18.5204, // Default to Pune/Campus area
  lng: 73.8567
};
...
export default function LocationPicker({ value, onChange }) {
  ...
  if (!isLoaded) {
    return (
      <div className="flex flex-col items-center justify-center p-8 border-2 border-dashed border-gray-300 bg-gray-50 text-gray-500" style={{ borderRadius: RADIUS.wobblySm }}>
        ...
        <p className="font-body text-sm text-center">Loading Interactive Map...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-2">
      ...
      <div 
        className="border-2 border-[#2d2d2d] shadow-[2px_2px_0px_#2d2d2d] overflow-hidden" 
